...
srun --export=ALL,OMP_PROC_BIND=spread /work/pi_gkhanna_uri_edu/Nikola/kharma/kharma.cuda -r /project/u2grc/Nikola/newSimulations/KHLow/torus.out1.00199.rhdf
