...
#for ((i=1824; i<1825; i++)); do
    ...
    /work/pi_gkhanna_uri_edu/Nikola/ipole/ipole -par /work/pi_gkhanna_uri_edu/Nikola/ipole/model/iharm/example.par --M_unit=$Mfit --dump=/project/u2grc/Nikola/newSimulations/$1/"${arr[$i]}" --outfile=/project/u2grc/Nikola/newSimulations/$1/ipole/replot_n_-1_res_400/image_"${arr[$i]}"
done
