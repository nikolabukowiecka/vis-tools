...
srun --export=ALL,OMP_PROC_BIND=spread /work/pi_gkhanna_uri_edu/Nikola/kharma/kharma.cuda -i /work/pi_gkhanna_uri_edu/Nikola/kharma/pars/tori_3d/test_pars/mad_KHMid.par
